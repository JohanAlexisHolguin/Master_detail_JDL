		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail JDL",
									"targetURL": "#MasterDetailJDL-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MasterDetailJDL-display": {
								"semanticObject": "MasterDetailJDL",
								"action": "display",
								"description": "Template Master Detail ",
								"title": "Master Detail JDL",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=co.com.jdl.zui5_master-detail",
									"url": sap.ui.require.toUrl("co/com/jdl/zui5_master-detail")
								}
							}
						}
					}
