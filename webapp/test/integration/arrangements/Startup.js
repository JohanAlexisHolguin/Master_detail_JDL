sap.ui.define([
	"sap/ui/test/Opa5",
	"co/com/jdl/zui5_master-detail/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("co.com.jdl.zui5_master-detail.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "co.com.jdl.zui5_master-detail",
					async: true
				},
				hash: oOptions.hash,
